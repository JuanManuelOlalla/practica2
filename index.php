<?php
    require 'php/clases/Request.php';
        ...
        <div id="imagen_central">
            ...
            <div style="padding-top:1%; padding-bottom:2%; width:99%; text-align:justify;">
                ...
                <div style="margin-left: 2%;  width: 90%;">
                    <form name="Formulario_validacion"  class="tabla_formulario" style="padding: 0.5em; width: 99%; background-color: #f5f5f5;" title="Identificación sin Certificado Digital" method="post" action="php/phpCrearCita.php" enctype="multipart/form-data" >
                        ...
                        <input required class="campos" type="text" id="nuss" name="numero" size="17" maxlength="12"  style="position:relative; left:6%;" />
                        <br/>
                        <fieldset style="padding-bottom: 1em; border: 0px; margin-top: 10px;" title="Fecha de Nacimiento">
                            ...
                            <div style="position:relative; left:25%;">
                                <label for="dia" class="etiquetas_campos">D&iacute;a</label>
                                <input required type="text" class="campos" name="dia" id="dia_id" size="2" maxlength="2" />
                                <label for="mes" class="etiquetas_campos">Mes</label>
                                <input required type="text" class="campos" name="mes" id="mes_id" size="2" maxlength="2" />
                                <label for="anio" class="etiquetas_campos">A&ntilde;o</label>
                        ...
                        <fieldset style="border: 0px;" title="Imágenes tele diagnóstico">
                            ...
                            <div style="position:relative; left:15%;">
                                <input type="button" class="boton" id="btSubir" value="Agregar" /> <br/><br/><?php echo "<span style=\"color:red\">".$error."</span>"; ?>
                            </div>
                    ...
                    <form name="formularioBuscar"  class="tabla_formulario" style="padding: 0.5em; width: 99%; background-color: #f5f5f5;" title="Identificación sin Certificado Digital" method="post" action="php/phpVerNumero.php" enctype="multipart/form-data" >
                        <br/>
                        <label for="nuss" class="etiquetas_campos"><img style="border:none" src="img/cuadradito_verde.gif" alt="" />&nbsp;&nbsp;Buscar por Nº de Tarjeta Sanitaria:</label>
                        <input required class="campos" type="text" id="nuss" name="numero" size="17" maxlength="12"  style="position:relative; left:6%;" />
                        <br/><br/><input type="submit" value="buscar"/><br/><br/>
                    </form>
                </div>
                <br />
                <br />
